    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          'https://nexusbackend-5dd861750109.herokuapp.com/customer/customers'
        );
        ...
        <div className="flex h-screen -mt-90 px-20">
          <div className="flex- p-4 overflow-y-auto bg-white text-black">
            <div className="">
              ...
              <button
                className="w-1/5 bg-blue-800 mt-[-4%] flex ml-[70%] justify-center text-white p-3 rounded-full hover:bg-blue-700 text-xl font-bold mx-auto"
              ...
              {showForm && (
                <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-90 flex items-center justify-center z-50">
                  <div className="popup-content">
                    <span
                      className="close text-white text-xl ml-[100%]"
                      onClick={() => setShowForm(false)}
                    >
                      &times;
                    </span>

                    <h2 className="text-white justify-center text-[30px] flex font-extrabold">
                      Add A New User
                    </h2>
                    <form onSubmit={handleFormSubmit}>
                      <div className="mb-4">
                        <div className="grid grid-cols-1 gap-4">
                          <div>
                            ...
                            <input
                              className="border border-gray-300 py-2 px-24 w-full rounded"
                              type="text"
                              value={formData.name}
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          <div>
                            <label className=" text-white mb-2 mt-4">Phone Number</label>
                            <input
                              className="border border-gray-300 py-2 px-24 w-full rounded"
                              type="phonenumber"
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          <div>
                            <label className=" text-white mb-2 mt-5">Company Name</label>
                            <input
                              className="border border-gray-300 py-2 px-24 w-full rounded"
                              type="company_name"
                      ...
                      <div className="flex justify-center font-bold text-xl pt-10 ">
                        <button
                          type="submit"
                          className="bg-blue-500 text-white py-2 px-20 rounded"
